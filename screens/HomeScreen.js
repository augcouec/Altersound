...
export default function HomeScreen({ navigation }) {
  return (
    ...
    Nouvelle playlists dans :{" "}
    </Text>
    <Text style={styles.page_title_countdown}>
    J-5{" "}
    </Text>
...
/>
  ...
  <Text style={styles.song_title}>
    <B>Dj Quads</B> - Birds And The Bees{" "}
      ...
      <Text style={styles.song_title}><B>Lemmino</B> - Infinity </Text>
        <Text style={styles.song_title}><B>Ryan Little</B> - Lucy’s Song </Text>
          <Text style={styles.song_title}><B>Lemmino</B> - Infinity </Text>
            </View>
            <AntDesign
